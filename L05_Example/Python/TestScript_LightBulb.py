...
def init_plot():
    ...
    plt.xlabel("TRIAC firing angle [deg]")
    plt.ylabel("Illuminance [lx]")
    plt.title("Light bulb-BH1750 sensor characteristic")
    plt.grid()
    plt.xlim(0, 180)  # Adjust this as needed
    plt.ylim(0, 500)  # Adjust this based on expected range of received values
    plt.show()
