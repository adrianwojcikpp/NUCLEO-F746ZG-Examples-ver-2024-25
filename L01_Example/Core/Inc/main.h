...
#define ON_Btn_Pin GPIO_PIN_11
#define ON_Btn_GPIO_Port GPIOC
#define ON_Btn_EXTI_IRQn EXTI15_10_IRQn
#define OFF_Btn_Pin GPIO_PIN_12
#define OFF_Btn_GPIO_Port GPIOC
#define OFF_Btn_EXTI_IRQn EXTI15_10_IRQn
#define ENC_CLK_Pin GPIO_PIN_9
#define ENC_CLK_GPIO_Port GPIOG
