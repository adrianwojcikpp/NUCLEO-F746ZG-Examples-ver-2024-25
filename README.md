...
Projekt stworzony za pomocą środowiska STM32CubeIDE w wersji **1.16.1** oraz firmware STM32CubeF7 w wersji **1.17.2**.
...
Project created using the STM32CubeIDE environment, version **1.16.1** and STM32CubeF7 firmware package, version **1.17.2**.
